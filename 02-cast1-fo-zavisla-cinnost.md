# Kapitola 02 — Část první, Daň z příjmů fyzických osob: příjmy ze závislé činnosti (§ 6—6a)

## Přehled

Ustanovení **§ 6 ZDP** vymezuje **příjmy ze závislé činnosti** — historicky a hovorově označované jako „příjmy ze zaměstnání" — které tvoří kvantitativně nejvýznamnější dílčí základ daně z příjmů fyzických osob. Závislá činnost je v pojetí ZDP širší než pracovní poměr ve smyslu *zákoníku práce* (zákon č. 262/2006 Sb., dále „ZP"): zahrnuje sice typicky pracovněprávní vztahy, ale rozšiřuje se i na poměry služební, členské a obdobné, dále na práci společníků s. r. o., komanditistů, členů družstev, na odměny členů orgánů právnických osob a likvidátorů a na **funkční požitky**. Společným pojmovým znakem je faktická **podřízenost poplatníka příkazům plátce** při výkonu práce (§ 6 odst. 1 písm. a) bod 1).

Charakteristickým rysem zdanění příjmů ze závislé činnosti je **dělba rolí mezi poplatníkem a plátcem**. Poplatníkem (osobou, jejíž příjem se zdaňuje) je *zaměstnanec*; plátcem daně, který nese odpovědnost za výběr a odvod daně (zálohy či srážkové daně), je *zaměstnavatel* (§ 6 odst. 2). Daň se proto u převážné většiny zaměstnanců nevybírá až po skončení zdaňovacího období prostřednictvím daňového přiznání, nýbrž **průběžně formou měsíčních záloh sražených zaměstnavatelem** (mechanismus → § 38h a násl.) nebo formou **srážkové daně zvláštní sazbou** (§ 6 odst. 4 ve spojení s → § 36).

Zásadní pojmovou změnou účinnou od **1. ledna 2021** bylo zrušení tzv. **superhrubé mzdy**. Až do roku 2020 byl základem daně příjem zaměstnance navýšený o povinné pojistné hrazené zaměstnavatelem; od roku 2021 platí, že **základem daně (dílčím základem daně) jsou prostě příjmy ze závislé činnosti** (§ 6 odst. 12) — tedy hrubá mzda bez navyšování o pojistné. Tomu odpovídá i nynější dvousazbová progresivní stupnice daně (15 % a 23 %) podle → § 16.

Druhou výraznou novelou bylo **přepracování úpravy zaměstnaneckých benefitů od 1. ledna 2024** (tzv. konsolidační balíček, zákon č. 349/2023 Sb.), které do § 6 odst. 9 zavedlo **roční limity osvobození** nepeněžních volnočasových plnění (zdravotní plnění do výše průměrné mzdy, kulturní/sportovní/rekreační plnění do poloviny průměrné mzdy) a omezilo daňové zvýhodnění příspěvku na stravování. Od **1. ledna 2025** přibyla speciální úprava **zaměstnaneckých akcií a opcí** (§ 6 odst. 14 až 17) a samostatný **§ 6a o kvalifikovaných zaměstnaneckých opcích**.

### Souhrnná tabulka — struktura zdanění příjmů ze závislé činnosti

| Okruh | Obsah dle § 6 ZDP | Klíčový režim |
|---|---|---|
| **Druhy příjmů (odst. 1)** | pracovněprávní/služební/členský poměr, funkční požitek; práce člena družstva, společníka s. r. o., komanditisty; odměny člena orgánu PO a likvidátora; navazující příjmy | dílčí základ daně dle § 6 odst. 12 |
| **Poplatník vs. plátce (odst. 2)** | poplatník = *zaměstnanec*; plátce = *zaměstnavatel* | výběr daně plátcem → § 38h |
| **Co není předmětem daně (odst. 7)** | cestovní náhrady do limitu, OOPP a pracovní oděvy, zálohy a refundace, náhrady za opotřebení nářadí, plnění na pracovní podmínky | mimo zdanění |
| **Osvobozené příjmy (odst. 9)** | odborný rozvoj, příspěvek na stravování (do 70 % limitu), nealko nápoje, FKSP/volnočasové benefity (s ročními limity), jízdenky, příspěvek na produkty spoření na stáří (do 50 000 Kč) ad. | osvobození od daně |
| **Funkční požitky (odst. 10—11)** | funkční platy ústavních činitelů a soudců; odměny za výkon funkce v obcích, státních orgánech, spolcích, komorách | zdaněny jako závislá činnost |
| **Srážková daň (odst. 4)** | DPP do limitu nemocenského pojištění; jiné příjmy do rozhodné částky — bez prohlášení | zvláštní sazba → § 36 |

### Plátce vs. poplatník

| Subjekt | Role | Povinnosti |
|---|---|---|
| **Zaměstnanec** (poplatník) | osoba, jejíž příjem podléhá dani | učinit/neučinit prohlášení k dani (§ 38k), případně podat daňové přiznání |
| **Zaměstnavatel** (plátce) | osoba vyplácející příjem | srazit zálohu/srážkovou daň, vést mzdové listy → § 38j, podat vyúčtování, provést roční zúčtování → § 38ch |

### Zdanění zaměstnaneckých benefitů (přehled)

| Benefit | Daňový režim u zaměstnance | Limit |
|---|---|---|
| Služební vozidlo k soukromým účelům | nepeněžní příjem (% vstupní ceny/měsíc) | 0,25 % / 0,5 % / 1 % dle emisí, min. 1 000 Kč |
| Příspěvek na stravování (stravenkový paušál i nepeněžní) | osvobozeno do limitu | 70 % horní hranice stravného (5—12 h) |
| Volnočasové benefity (rekreace, sport, kultura) | osvobozeno do limitu | polovina průměrné mzdy ročně |
| Zdravotní plnění (léčiva na předpis ad.) | osvobozeno do limitu | průměrná mzda ročně |
| Příspěvek na produkty spoření na stáří / dlouhodobé péče | osvobozeno do limitu | 50 000 Kč ročně |
| Bezúročná zápůjčka | osvobozen majetkový prospěch | jistina do 300 000 Kč |
| Přechodné ubytování | osvobozeno do limitu | 3 500 Kč měsíčně |

### Dohody DPP a DPČ

| Znak | DPP (dohoda o provedení práce) | DPČ (dohoda o pracovní činnosti) |
|---|---|---|
| Pramen | § 75 ZP | § 76 ZP |
| Rozsah práce | max. 300 h / rok u jednoho zaměstnavatele | omez. podle § 76 ZP |
| Srážková daň (§ 6 odst. 4 písm. a) | ANO, pokud měsíční úhrn nedosáhne částky rozhodné pro účast na nemocenském pojištění a poplatník neučiní prohlášení | — |
| Srážková daň (§ 6 odst. 4 písm. b) | — | ANO, do rozhodné částky pro účast na nemocenském pojištění |
...
Tento autonomní výklad má praktický dopad při posuzování tzv. **„švarcsystému"** (zastírání závislé práce formálně samostatnou podnikatelskou činností OSVČ). Zatímco z hlediska zaměstnanosti jde o nelegální práci (zákon č. 435/2004 Sb., o zaměstnanosti), z daňového hlediska může správce daně příjmy překvalifikovat z → § 7 (samostatná činnost) na § 6 se všemi důsledky (zálohy, pojistné). Hranice mezi závislou a samostatnou činností je předmětem ustálené *judik.* správních soudů (nutno ověřit konkrétní spisové značky NSS); rozhodující jsou znaky soustavnosti, osobního výkonu, podřízenosti, výkonu jménem a na účet zaměstnavatele a poskytování pracovních prostředků.

Vedle základního typu jsou závislou činností i:
- **funkční požitky** (odst. 1 písm. a) bod 2, blíže odst. 10);
- **příjmy za práci** člena družstva, **společníka s. r. o.** a **komanditisty** k. s. (odst. 1 písm. b)) — zde nejde o pracovněprávní vztah, ale o specifický korporační vztah; podstatné je, že odměna za práci společníka s. r. o. spadá vždy pod § 6, a to i bez uzavřené pracovní smlouvy;
- **odměny člena orgánu právnické osoby** (např. jednatele, člena představenstva, dozorčí rady) a **odměny likvidátora** (odst. 1 písm. c)) — vztah člena voleného orgánu se řídí zákonem o obchodních korporacích (zákon č. 90/2012 Sb.), nikoli ZP, daňově se však jeho odměna posuzuje jako příjem ze závislé činnosti;
- **navazující příjmy** podle písm. d) — plnění plynoucí v souvislosti se současným, budoucím či dřívějším výkonem činnosti, a to bez ohledu na osobu plátce (např. příspěvky bývalého zaměstnavatele, plnění od třetí osoby) s výjimkou *úroku z prodlení*.

> **Příklad — společník s. r. o.:** Pan *Novák* je jednatelem a 100% společníkem s. r. o. a měsíčně si vyplácí odměnu za práci pro společnost ve výši 50 000 Kč. Tato odměna je příjmem ze závislé činnosti podle § 6 odst. 1 písm. b) bodu 2, resp. písm. c) bodu 1 (jako odměna člena orgánu); společnost z ní jako plátce sráží zálohu na daň → § 38h a odvádí pojistné. Naproti tomu **podíl na zisku** (dividenda) vyplácený témuž společníkovi není příjmem podle § 6, nýbrž příjmem z kapitálového majetku → § 8.

#### 2. Zaměstnanec, zaměstnavatel a mezinárodní pronájem pracovní síly (odst. 2)

Odstavec 2 zavádí legislativní zkratky: **poplatník = zaměstnanec**, **plátce = zaměstnavatel**. Tyto pojmy jsou pro daňové účely širší než v ZP — zaměstnancem je i jednatel, společník nebo člen voleného orgánu pobírající příjem podle odst. 1.

Druhá až čtvrtá věta řeší **mezinárodní pronájem pracovní síly** (*international hiring-out of labour*). Pokud zaměstnanci formálně vyplácí mzdu zahraniční osoba (zahraniční agentura práce), avšak práci vykonávají podle příkazů tuzemského subjektu, je daňovým zaměstnavatelem **ekonomický zaměstnavatel** se sídlem v ČR (poplatník dle § 2 odst. 2 nebo § 17 odst. 3), který nese povinnosti plátce. Pokud úhrada zahraniční osobě obsahuje i odměnu za zprostředkování, považuje se za příjem zaměstnance **nejméně 60 %** celkové úhrady (zbytek se připouští jako odměna zprostředkovatele). Výjimka platí pro agentury z jiného členského státu EU/EHP s organizační složkou v ČR oprávněnou ke zprostředkování zaměstnání.

#### 3. Šíře pojmu příjem; nepeněžní plnění (odst. 3)

Odstavec 3 stanoví **maximálně široký pojem příjmu**: příjmem ze závislé činnosti jsou plnění pravidelná i jednorázová, nárokovatelná i nenárokovatelná, vyplácená v penězích i připisovaná k dobru, jakož i **plnění v jiné formě** (nepeněžní). Příjmem je i plnění poskytnuté nikoli zaměstnanci, nýbrž jiné osobě (typicky rodinnému příslušníkovi), je-li poskytnuto za zaměstnance nebo v jeho prospěch.

Klíčový je institut **zvýhodněné ceny**: příjmem zaměstnance je i částka, o kterou je jeho úhrada zaměstnavateli **nižší** než:
- cena obvyklá podle zákona upravujícího oceňování majetku (zákon č. 151/1997 Sb.) nebo cena účtovaná jiným osobám (písm. a);
- cena stanovená podle odst. 6 u služebního vozidla k soukromým účelům (písm. b);
- cena stanovená podle odst. 18 u zařízení péče o děti předškolního věku (písm. c).

> **Příklad — sleva na zboží:** Prodejce elektroniky umožní zaměstnanci koupit notebook v obvyklé ceně 30 000 Kč za 18 000 Kč. Rozdíl **12 000 Kč** je nepeněžním příjmem ze závislé činnosti a podléhá zdanění (pokud nejde o osvobozené plnění).

Poslední věta odst. 3 obsahuje **výjimku pro kvalifikované zaměstnanecké opce**: příjem z jejich realizace ve výši dle § 6a odst. 7 se za příjem podle odst. 1 nepovažuje (přesouvá se do → § 10 — ostatní příjmy; viz výklad k → § 6a).

#### 4. Srážková daň a dohody DPP/DPČ (odst. 4 a 5)

Odstavec 4 zakládá **režim samostatného základu daně zdaňovaného srážkou** zvláštní sazbou (15 % podle → § 36). Uplatní se, pokud zaměstnanec **neučinil prohlášení k dani** podle → § 38k a jde o:
- **dohodu o provedení práce** (DPP, § 75 ZP), jejíž měsíční úhrn u téhož plátce nedosáhne částky rozhodné pro účast na nemocenském pojištění zaměstnanců činných na DPP (písm. a);
- **jiné příjmy** v měsíčním úhrnu nedosahujícím u téhož plátce rozhodné částky pro účast na nemocenském pojištění (písm. b) — týká se zejména DPČ s nízkou odměnou a drobných odměn.

Rozhodné částky se navazují na předpisy o nemocenském pojištění (zákon č. 187/2006 Sb.) a o pojistném na sociální zabezpečení (zákon č. 589/1992 Sb.); jejich výše se valorizuje, proto ZDP odkazuje dynamicky. Pokud zaměstnanec **prohlášení učiní**, vybírá se daň zálohově (→ § 38h) a uplatní se slevy na dani.

Plynou-li příjmy podle odst. 4 ze zahraničí, jsou dílčím základem daně podle § 5 odst. 2 (odst. 5).

> **Příklad — DPP a srážková daň:** Student pracuje na DPP s odměnou 9 000 Kč/měsíc (pod rozhodnou částkou pro nemocenské pojištění u DPP) a neučinil prohlášení. Plátce srazí srážkovou daň 15 %, tj. 1 350 Kč. Student může příjem zahrnout do daňového přiznání (→ § 36 odst. 6/7) a sraženou daň započíst — tím při uplatnění slevy na poplatníka (→ § 35ba) zpravidla dosáhne vrácení daně.

#### 5. Služební vozidlo k soukromým účelům (odst. 6)

Poskytne-li zaměstnavatel **bezplatně silniční motorové vozidlo i pro soukromé účely**, vzniká zaměstnanci nepeněžní příjem ve výši **určeného procenta vstupní ceny** vozidla za každý i započatý kalendářní měsíc, nejméně však **1 000 Kč** měsíčně. Sazby diferencuje podle ekologického profilu vozidla:

| Typ vozidla | Určené procento ze vstupní ceny / měsíc |
|---|---|
| bezemisní | **0,25 %** |
| nízkoemisní | **0,5 %** |
| ostatní (běžný spalovací motor) | **1 %** |

Vstupní cena se počítá včetně DPH; u vozidla na finanční leasing se vychází ze vstupní ceny u **původního vlastníka**. Při více vozidlech postupně za sebou v měsíci se použije nejvyšší vstupní cena; při souběhu více vozidel současně se příjmy sčítají.

> **Příklad — výpočet u vozidla:** Zaměstnavatel poskytne spalovací vozidlo se vstupní cenou (vč. DPH) 600 000 Kč. Nepeněžní příjem = 1 % z 600 000 Kč = **6 000 Kč/měsíc**, který se přičítá k hrubé mzdě a vstupuje do základu daně i do vyměřovacího základu pojistného. U bezemisního vozidla téže ceny by činil jen 0,25 %, tj. 1 500 Kč.

#### 6. Plnění mimo předmět daně (odst. 7 a 8)

Odstavec 7 vymezuje plnění, která **nejsou předmětem daně** (nikoli osvobozená — jde o plnění mimo daňový dosah, neboť nemají povahu odměny za práci, ale kompenzace nákladů zaměstnance):
- **cestovní náhrady** do limitu pro zaměstnance odměňovaného platem (vazba na část sedmou ZP a vyhlášky MPSV o stravném); plnění nad limit jsou zdanitelná (písm. a);
- **OOPP, pracovní oděvy a obuv, mycí a čisticí prostředky, ochranné nápoje, stejnokroje** a pracovní oblečení určené zaměstnavatelem (písm. b);
- zálohy a **refundace prokázaných výdajů** vynaložených za zaměstnavatele (písm. c);
- **náhrady za opotřebení vlastního nářadí** podle ZP (písm. d);
- **plnění na vytváření pracovních podmínek**, včetně paušální náhrady nákladů při práci z jiného místa (**home office paušál**) do výše paušálu pro zaměstnance odměňovaného platem (písm. e).

Odstavec 8 upravuje **paušalizaci** náhrad podle písm. b) až d): paušál se uznává do výše stanovené předpisem nebo do výše kalkulované zaměstnavatelem na základě skutečných výdajů (musí být prokazatelně doloženo). U paušálu za vlastní nářadí, které by jinak bylo odpisováno, platí strop ve výši srovnatelných rovnoměrných odpisů.

#### 7. Osvobozené příjmy zaměstnance (odst. 9) — zaměstnanecké benefity

Odstavec 9 je systematicky nejvýznamnější částí § 6 z hlediska personální praxe — vymezuje **osvobozené zaměstnanecké benefity**. Po novele účinné od 1. ledna 2024 došlo k podstatnému zpřísnění a zavedení **ročních limitů** odvozených od **průměrné mzdy** (vyhlašuje MPSV; pro orientaci řádově desítky tisíc Kč měsíčně, ročně tedy stovky tisíc).

**a) Odborný rozvoj a rekvalifikace** (písm. a) — osvobozeno je *nepeněžní* plnění na odborný rozvoj související s předmětem činnosti zaměstnavatele; osvobození se nevztahuje na peněžní plnění ani na náhradu ušlého příjmu.

**b) Příspěvek na stravování / „stravenkový paušál"** (písm. b) — osvobozen do **70 % horní hranice stravného** při pracovní cestě trvající 5 až 12 hodin (pro zaměstnance odměňované platem). Klíčovou novelou roku 2021 bylo zrovnoprávnění **peněžitého příspěvku na stravování** („stravenkový paušál") s nepeněžními formami (závodní stravování, stravenky) — pro osvobození platí jednotný limit. Podmínkou je výkon práce alespoň **3 hodiny** během směny (resp. dne u nesměnných režimů) a absence nároku na stravné z titulu cestovních náhrad; při směně/dni delším než 11 hodin lze osvobodit i druhý příspěvek.

> **Příklad — stravenkový paušál:** Je-li horní hranice stravného (5—12 h) např. 166 Kč, činí 70 % = 116,20 Kč; osvobozený příspěvek lze zaokrouhleně poskytnout do cca **116 Kč denně**. (Konkrétní částka se každoročně mění vyhláškou MPSV — nutno ověřit pro daný rok.)

**c) Nealkoholické nápoje** ke spotřebě na pracovišti jako nepeněžní plnění (písm. c).

**d) Volnočasové benefity z FKSP / sociálního fondu** (písm. d) — nepeněžní plnění z **fondu kulturních a sociálních potřeb** (FKSP — u veřejného sektoru dle vyhlášky č. 114/2002 Sb.), sociálního fondu nebo ze zisku po zdanění. Od roku 2024 platí **dva samostatné roční limity**:
- *zdravotní plnění* (zboží/služby zdravotního charakteru, zdravotnické prostředky na lékařský předpis) — osvobozeno do výše **průměrné mzdy** za zdaňovací období (bod 1);
- *ostatní volnočasová plnění* (rekreace, zájezdy, vzdělávací/rekreační/sportovní zařízení, knihovna, příspěvek na kulturní/sportovní akce, tištěné knihy) — osvobozeno do výše **poloviny průměrné mzdy** za zdaňovací období (bod 2).

Plnění nad limit je zdanitelným příjmem a vstupuje i do vyměřovacích základů pojistného.

**e) Jízdenky** poskytované dopravcem svým zaměstnancům (písm. e).

**f) Příjmy nerezidentů** od zahraničního zaměstnavatele při pobytu **do 183 dnů** v jakémkoli období 12 měsíců (písm. f) — domácí transpozice tzv. **doložky 183 dnů** ze smluv o zamezení dvojího zdanění; neplatí pro umělce, sportovce a činnost vykonávanou ve stálé provozovně.

**g) Společenské akce** (písm. g) — osvobozena nepeněžní plnění z účasti na firemní společenské/sportovní/kulturní akci pro omezený okruh účastníků, je-li její pořádání obvyklé a forma i rozsah přiměřené (např. firemní vánoční večírek).

**h) — ch)** Naturální a výstrojní náležitosti, zvláštní požitky a náhrady majetkové újmy příslušníků ozbrojených sil a bezpečnostních sborů.

**i) Přechodné ubytování** poskytované nepeněžně do **3 500 Kč měsíčně**, není-li obec ubytování shodná s obcí bydliště (písm. i).

**m) Příspěvek na produkty spoření na stáří** (písm. m) — příspěvek zaměstnavatele na daňově podporované produkty spoření na stáří (penzijní připojištění, doplňkové penzijní spoření, dlouhodobý investiční produkt) nebo na pojištění dlouhodobé péče je osvobozen do **úhrnné výše 50 000 Kč ročně**. Tento limit byl od roku 2024 sjednocen (dříve odděleně penzijní a životní pojištění s nižšími limity).

**p) Náhrada mzdy za prvních 14 dnů nemoci** (písm. p) — náhrada mzdy/platu za dobu dočasné pracovní neschopnosti či karantény podle § 192 ZP do výše minimálního zákonného nároku je osvobozena.

**r) Majetkový prospěch z bezúročné zápůjčky** (písm. r) — osvobozen do úhrnné jistiny **300 000 Kč**; z částky nad tento limit se majetkový prospěch ocení podle odst. 3 a zdaní nejpozději při zúčtování mzdy za prosinec.

**s) Odměna člena okrskové volební komise** (písm. s) — osvobozena.

**t) Stravování pro starobní/invalidní důchodce — bývalé zaměstnance** (písm. t) — osvobozeno do 70 % horní hranice stravného za kalendářní den, snížené o příspěvek osvobozený podle písm. b).

#### 8. Funkční požitky (odst. 10 a 11)

**Funkčními požitky** jsou:
- **funkční platy** ústavních činitelů a soudců podle zákona č. 236/1995 Sb. a zabezpečení prezidenta po skončení funkce (písm. a);
- **odměny za výkon funkce** v orgánech obcí a územní samosprávy, ve státních orgánech, ve spolcích a zájmových sdruženích, v odborových organizacích, v komorách a jiných orgánech a institucích (písm. b).

Typickým příjemcem funkčního požitku je **uvolněný zastupitel obce** (odměna podle zákona č. 128/2000 Sb., o obcích). Naproti tomu odst. 11 výslovně vylučuje z funkčních požitků příjmy **znalců, tlumočníků, zprostředkovatelů kolektivních sporů a rozhodců** za činnost podle zvláštních předpisů — ty se zdaňují v jiném dílčím základu (typicky → § 7 nebo → § 10).

#### 9. Dílčí základ daně a zrušení superhrubé mzdy (odst. 12)

Odstavec 12 v současném znění stručně stanoví: **„Základem daně (dílčím základem daně) jsou příjmy ze závislé činnosti."** Toto lakonické ustanovení je výsledkem zásadní reformy účinné od **1. ledna 2021**, kterou byla zrušena **superhrubá mzda**.

> **Historický exkurz — superhrubá mzda:** V letech 2008—2020 byl dílčím základem daně příjem zaměstnance navýšený o **povinné pojistné hrazené zaměstnavatelem** (sociální + zdravotní, dohromady tehdy 34 % hrubé mzdy). Nominální sazba daně 15 % se tak aplikovala na základ cca 1,34násobku hrubé mzdy — efektivní zdanění tedy činilo přibližně **20,1 %** hrubé mzdy. Od roku 2021 se navyšování zrušilo a sazba 15 % (resp. 23 % pro nadlimitní část) se aplikuje přímo na hrubou mzdu.

> **Příklad — výpočet měsíční zálohy (současný stav):** Hrubá mzda 50 000 Kč, zaměstnanec podepsal prohlášení a uplatňuje pouze základní slevu na poplatníka.
> - Základ daně (zaokrouhlený na celé stokoruny nahoru pro zálohu) = 50 000 Kč.
> - Záloha 15 % = 7 500 Kč.
> - Sleva na poplatníka (→ § 35ba) — měsíčně 1/12 roční slevy; tato se odečte od zálohy.
> - Po odečtení slevy vznikne **záloha k odvedení** (→ § 38h). Sociální (6,5 %) a zdravotní (4,5 %) pojistné hrazené zaměstnancem se sráží zvlášť a do daňového základu se již nezahrnuje.

Srovnání obou systémů:

| Položka | Superhrubá mzda (do 2020) | Současný stav (od 2021) |
|---|---|---|
| Základ daně | hrubá mzda + pojistné zaměstnavatele (× 1,34) | hrubá mzda |
| Nominální sazba | 15 % (+ 7% solidární zvýšení nad strop) | 15 % / 23 % (→ § 16) |
| Efektivní sazba na hrubou mzdu | cca 20,1 % | 15 % (do limitu) |

#### 10. Příjmy ze zahraničí (odst. 13)

Odstavec 13 upravuje stanovení základu daně u **rezidentů s příjmy ze zahraničí**:
- u státu **bez smlouvy** o zamezení dvojího zdanění: příjem snížený o daň zaplacenou v zahraničí (metoda zahrnutí daně do nákladů);
- u státu **se smlouvou**: příjem ze závislé činnosti vykonávané v daném státě, přičemž zaplacenou zahraniční daň lze odečíst jen v rozsahu, v němž ji nebylo možno započíst podle → § 38f v bezprostředně předchozím zdaňovacím období.

Toto ustanovení doplňuje obecnou úpravu metod zamezení dvojího zdanění (zápočet/vynětí) v → § 38f.

#### 11. Zaměstnanecké akcie a opce (odst. 14 až 17)

Odstavce 14 až 17 (účinné od 1. ledna 2024, resp. 2025) zavádějí **odklad zdanění** nepeněžního příjmu zaměstnance z **nabytí podílu v obchodní korporaci** (zaměstnavatele nebo mateřské/dceřiné/kapitálově spojené společnosti) nebo z **opce** na jeho nabytí. Cílem je řešit problém zdanění tzv. **ESOP** (employee stock ownership plans) v okamžiku, kdy zaměstnanec ještě nemá likviditu (akcie nejsou zpeněžitelné).

Příjem se podle odst. 14 považuje za zúčtovaný (a tedy zdanitelný) až k **prvnímu z okamžiků realizace**:
- a) ukončení činnosti u zaměstnavatele/skupiny;
- b) vstup zaměstnavatele do likvidace;
- c) převod nebo přechod podílu/opce;
- d) uplatnění opce;
- e) výměna podílu měnící jmenovitou hodnotu;
- f) **uplynutí 15 let** od nabytí.

Odstavec 15 umožňuje příjem **snížit** o nárůst hodnoty podílu/opce mezi nabytím a okamžikem realizace (zdanit se má v zásadě hodnota při nabytí, nikoli pozdější zhodnocení). Odstavce 16 a 17 upravují **oznamovací povinnosti** poplatníka a zaměstnavatele vůči správci daně.

#### 12. Ocenění zařízení péče o děti (odst. 18)

Nepeněžní příjem ze **školky/dětské skupiny** poskytnuté rodinnému příslušníkovi zaměstnance se ocení obvyklou cenou za veřejnou mateřskou školu nebo nejvyšší úplatou za předškolní vzdělávání podle vyhlášky, poměrně podle doby používání. Způsob ocenění volí zaměstnavatel.

#### 13. Vztah k jiným předpisům

- **Zákoník práce (262/2006 Sb.):** vymezuje pracovněprávní pojmy (mzda, plat, směna, cestovní náhrady, DPP/DPČ), na které ZDP navazuje, avšak daňové pojetí závislé činnosti je širší.
- **Pojistné na sociální zabezpečení (589/1992 Sb.) a veřejné zdravotní pojištění (592/1992 Sb.):** vyměřovací základy se z velké části kryjí se základem daně, osvobozené benefity z odst. 9 zpravidla nevstupují ani do pojistných základů (úzká vazba na § 5 zákona o pojistném).
- **Nemocenské pojištění (187/2006 Sb.):** rozhodné částky určují hranici srážkové daně u DPP/DPČ (odst. 4).
- **Zákon o DPH (235/2004 Sb.):** poskytnutí vozidla či jiných plnění zaměstnanci pro soukromou potřebu může být zdanitelným plněním z hlediska DPH; vstupní cena vozidla pro odst. 6 se počítá včetně DPH.
- **Daňový řád (280/2009 Sb.):** procesní rámec pro plátce daně — povinnost srazit, odvést, podat hlášení/vyúčtování, ručení plátce za daň.
...
#### 1. Účel a systematické zařazení

Ustanovení **§ 6a** zavedlo do ZDP samostatný a podrobný režim **kvalifikovaných zaměstnaneckých opcí** jako reakci na potřeby **startupového a technologického sektoru**, kde jsou zaměstnanecké opce (*employee stock options*) klíčovým nástrojem odměňování a udržení klíčových pracovníků. Bez zvláštní úpravy by realizace opce podléhala zdanění jako příjem ze závislé činnosti podle → § 6 v plné výši a v okamžiku realizace.

Systematicky § 6a působí jako **definiční ustanovení** pro zvláštní daňový režim, jehož hmotněprávní jádro je rozprostřeno do více ustanovení ZDP:
- → § 6 odst. 3 poslední věta — vyjímá příjem z realizace kvalifikované opce ve výši dle § 6a odst. 7 z příjmů ze závislé činnosti;
- → § 10 odst. 1 písm. q) — zařazuje tento příjem do **ostatních příjmů** (na který odkazuje § 6a odst. 8 písm. a);
- → § 38j a oznamovací povinnosti zaměstnavatele (jednotné měsíční hlášení zaměstnavatele).

Daňovou výhodou je tedy **přesun ze závislé činnosti do ostatních příjmů** s navázáním na splnění kvalifikačních podmínek a oznamovacích povinností. To má praktický dopad zejména na **vyměřovací základy pojistného** — příjem podle → § 10 nevstupuje do základů sociálního a zdravotního pojištění.

#### 2. Pojem kvalifikované zaměstnanecké opce (odst. 1)

**Kvalifikovanou zaměstnaneckou opcí** je **nepřevoditelný příslib nabýt kvalifikovaný obchodní podíl**, který kumulativně splňuje pět podmínek:
- a) je poskytnut **bezúplatně** kvalifikovaným zaměstnavatelem kvalifikovanému zaměstnanci;
- b) je poskytnut **písemnou smlouvou** opravňující nabýt podíl za sjednanou **opční cenu**;
- c) jeho poskytnutí bude **oznámeno správci daně** (odst. 8);
- d) podíl může být nabyt **nejdříve za 3 roky** od poskytnutí příslibu (tzv. *vesting period*), s výjimkou kratší doby při tzv. **liquidity eventu** — převodu/přechodu nejméně **67 %** podílu na třetí (nespojenou) osobu nebo při vstupu akcií na **veřejný akciový trh** (IPO);
- e) je sjednána povinnost zaměstnavatele **sdělit tržní cenu** podílu k okamžiku poskytnutí i k okamžiku uplatnění/vypořádání.

#### 3. Kvalifikovaný zaměstnanec (odst. 2)

Kvalifikovaným zaměstnancem je poplatník, který současně splňuje:
- a) **prahový limit podílu**: úhrn jeho kvalifikovaných obchodních podílů (nabytých i nabytelných z opcí) **nepřesahuje 5 %** — tj. režim cílí na řadové zaměstnance, nikoli na zakladatele/majoritní vlastníky;
- b) **dobu trvání výkonu činnosti** podle → § 6 odst. 1 písm. a) až c) pro zaměstnavatele **nejméně 12 měsíců** mezi poskytnutím a realizací opce;
- c) **minimální úhrn jiných příjmů** ze závislé činnosti (mimo příjmy z opcí) — alespoň **1,2násobek měsíční minimální mzdy** za každý měsíc výkonu činnosti podle písm. b). Tento test brání zneužití režimu k odměňování čistě opcemi bez reálné mzdy.

#### 4. Kvalifikovaný zaměstnavatel (odst. 3)

Kvalifikovaným zaměstnavatelem může být jen osoba, která v okamžiku poskytnutí opce splňuje **velikostní strop** (jde o cílení na malé a střední podniky / startupy):
- a) **roční obrat** nepřesahuje **2 500 000 000 Kč** a **úhrn aktiv** nepřesahuje **2 000 000 000 Kč**;
- b) není členem skupiny překračující tyto limity (na konsolidované bázi);
- c) **odvětvové vyloučení**: zaměstnavatel ani jiný člen skupiny nesmí být **bankou, pojišťovnou/zajišťovnou, organizací podle horního zákona, advokátem, daňovým poradcem ani auditorem** (resp. společností poskytující tyto regulované služby).

#### 5. Kvalifikovaný obchodní podíl a skupina (odst. 4 až 6)

**Kvalifikovaným obchodním podílem** (odst. 4) je podíl přímo na kvalifikovaném zaměstnavateli, nebo na jeho **přímo ovládající osobě** s podílem alespoň 50 % základního kapitálu (umožňuje opce na úrovni holdingové matky). Odstavce 5 a 6 vymezují **skupinu kvalifikovaného zaměstnavatele** pomocí kategorií ovládající osoby a ovládaných účetních jednotek (vazba na zákon o účetnictví) a definují **společné ovládání** jako ovládání na základě smlouvy vyžadující jednomyslnou shodu.

#### 6. Stanovení příjmu (odst. 7) — výpočet daňového základu

Odstavec 7 je hmotněprávním jádrem ocenění. Rozlišuje dva způsoby realizace:

**a) Uplatnění opce** (nabytí podílu): příjem = rozdíl, o který tržní cena podílu **v okamžiku uplatnění** převyšuje **vyšší** z částek:
- tržní cena podílu v okamžiku poskytnutí opce, nebo
- sjednaná opční cena.

**b) Finanční vypořádání** (cash settlement místo nabytí podílu): příjem = obdobně určený rozdíl, maximálně do výše rozdílu tržní ceny k datu vypořádání nad vyšší z týchž dvou částek.

Při stanovení příjmu se **nepřihlíží** k nárůstu ceny způsobenému vklady, přeměnami a obdobnými operacemi, ani k operacím porušujícím pravidlo obvyklých cen mezi spojenými osobami podle → § 23 odst. 7.

> **Příklad — výpočet příjmu z uplatnění opce:** Zaměstnanci je poskytnuta opce, tržní cena podílu při poskytnutí = 100 000 Kč, sjednaná opční cena = 80 000 Kč. Po 4 letech zaměstnanec opci uplatní, tržní cena podílu při uplatnění = 500 000 Kč. Vyšší z částek (tržní cena při poskytnutí 100 000 Kč vs. opční cena 80 000 Kč) = **100 000 Kč**. Příjem podle § 6a odst. 7 = 500 000 − 100 000 = **400 000 Kč**. Tento příjem se podle → § 6 odst. 3 nepovažuje za příjem ze závislé činnosti a zdaní se jako ostatní příjem podle → § 10 odst. 1 písm. q) — bez vstupu do pojistných základů.

#### 7. Oznamovací povinnosti (odst. 8 a 9)

Funkčnost celého režimu je podmíněna **oznámeními správci daně** ve lhůtě pro podání **jednotného měsíčního hlášení zaměstnavatele**:
- **při poskytnutí opce** (odst. 8): datum poskytnutí, sjednaná opční cena a tržní cena podílu ke dni poskytnutí, identifikační údaje zaměstnance;
- **při uplatnění/vypořádání** (odst. 9): identifikační údaje zaměstnance, datum, výši a hodnotu nabytého podílu nebo výši finančního vypořádání a okolnosti vypořádání.

Splnění oznamovací povinnosti je **podmínkou** uplatnění zvýhodněného režimu (odst. 1 písm. c).

#### 8. Vztah k jiným předpisům a křížové odkazy

- **Zákon o obchodních korporacích (90/2012 Sb.):** vymezuje obchodní podíl, ovládající/ovládanou osobu a koncernové vztahy.
- **Zákon o účetnictví:** definuje účetní jednotku a konsolidaci pro účely vymezení skupiny.
- **Zákon o oceňování majetku (151/1997 Sb.):** rámec pro stanovení tržní ceny podílu.
